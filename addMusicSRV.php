...
$sql = "insert into Music (trackName, artist, albumName, id, discNumber, trackNumber, spotifyURL) VALUES ('$trackName','$artist','$albumName','$id','$discNumber','$trackNumber','$spotifyURL')";
